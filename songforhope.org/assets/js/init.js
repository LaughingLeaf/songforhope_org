(function ($) {
  ...
  $( document ).ready(function() {
    ...
    //
    // Countdown
    var time = '2016/8/18'; //Change this date with your counting date. Its Format is "Y/M/D"
    ...
    $('.site-header').vegas({
        ...
        color: "white",
      slides: [
        { src: "assets/images/horizon_4.jpg" },
        { src: "assets/images/horizon_5.jpg" },
        { src: "assets/images/row_of_players.jpg" },
        { src: "assets/images/park_1.jpg" }
      ]
    });
